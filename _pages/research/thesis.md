...
{% include site/figure.html variant="portrait" src="/assets/media/research/thesis/images/defence-ninon.png" alt="Ninon presenting at the thesis defence, wearing a headset microphone beside a music stand holding a laptop, with the Neurorack module visible on a table to the right" caption="Defending at IRCAM, Salle Stravinsky, 12 May 2025. The Neurorack is on the table to the right." %}
