...
header:
  overlay_color: "#000"
  overlay_filter: "0.0"
  overlay_image: /assets/media/projects/neurorack/images/neurorack-banner.png
excerpt: "   "
toc: true
...
![NVIDIA Jetson Nano Board](/assets/media/projects/neurorack/images/jetson-nano.png "The NVIDIA Jetson Nano Developer Kit used in Neurorack")
...
![Hardware & Software Architecture Overview](/assets/media/projects/neurorack/images/architecture-overview.jpg "The diagram shows the interaction between the hardware (left) and software (right) components.")
...
![Adapted Sinc-NSF Model Architecture](/assets/media/projects/neurorack/images/sinc-nsf-model.jpg "Diagram of the Sinc-NSF model showing descriptor input, source generation, and filter blocks, BP and LP stand for Band-Pass and Low-Pass filters")
...
![Neurorack Faceplate Interface](/assets/media/projects/neurorack/images/faceplate.png)
...
<audio controls style="width: 100%; margin: 1.5rem 0;">
  <source src="/assets/media/projects/neurorack/audio/raster-demo.wav" type="audio/wav">
  Your browser does not support the audio element.
</audio>

**Video Teaser:**
{% include video id="64VpQenCHVs" provider="youtube" %}
